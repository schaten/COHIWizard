...
class Ui_resampler_widget(object):
    def setupUi(self, resampler_widget):
        ...
        resampler_widget.resize(1387, 715)
        self.gridLayoutWidget_4 = QtWidgets.QWidget(resampler_widget)
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(30, 20, 1141, 691))
