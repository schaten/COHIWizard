...
class Ui_wavheader_editor_widget(object):
    def setupUi(self, wavheader_editor_widget):
        ...
        wavheader_editor_widget.resize(1065, 689)
        ...
        self.tableWidget_3.setMinimumSize(QtCore.QSize(300, 192))
        self.tableWidget_3.setMaximumSize(QtCore.QSize(1500, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.tableWidget_3.horizontalHeader().setMinimumSectionSize(250)
